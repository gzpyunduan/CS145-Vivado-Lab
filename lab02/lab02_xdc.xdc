...
set_property IOSTANDARD LVDCMOS15 [get_ports {a[0]}] 
set_property IOSTANDARD LVDCMOS15 [get_ports {a[1]}] 
set_property IOSTANDARD LVDCMOS15 [get_ports {a[2]}] 
set_property IOSTANDARD LVDCMOS15 [get_ports {a[3]}] 

set_property PACKAGE_PIN AA10 [get_ports {b[3]}]
set_property PACKAGE_PIN AA11 [get_ports {b[2]}]
